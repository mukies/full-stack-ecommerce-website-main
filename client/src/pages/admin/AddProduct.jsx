...
export default function AddProduct() {
  ...
  async function submit(e) {
    e.preventDefault();
    try {
      if (!name || !price || !description || !category || !quantity || !photo) {
        ...
        const { data } = await axios.post(
          "https://meroshop-3vns.onrender.com/api/v1/product/add-product",
          product,
          {
            headers: {
          ...
          >
            ...
            {photo && (
              <div className="space-y-3 mx-2 my-3">
                <p className="text-lg font-bold">photo preview</p>
                <img
