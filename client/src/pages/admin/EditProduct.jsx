...
export default function EditProduct() {
  ...
  const dbPhoto = `https://meroshop-3vns.onrender.com/api/v1/product/product-image/${slug}`;
  ...
  async function productDetail() {
    const { data } = await axios.get(
      `https://meroshop-3vns.onrender.com/api/v1/product/get/${slug}`
    );
    ...
    try {
      if (!name || !price || !description || !category || !quantity) {
        ...
        const { data } = await axios.put(
          `https://meroshop-3vns.onrender.com/api/v1/product/update/${slug}`,
          product,
          {
            headers: {
          ...
          >
            ...
            <div className="space-y-3 mx-2 my-3">
              ...
              <img
                ...
                src={photo ? URL.createObjectURL(photo) : dbPhoto}
                alt="photo"
              />
            </div>
            <FormField
